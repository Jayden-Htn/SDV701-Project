...
VALUES 
	('Turf Terrorisor X', 5999.99, 4, null, 'Petrol, 20 litre tank', GETDATE(), 15.5, null, 1,
	...
	('Lawn Pro 2022', 449.99, 10, null, 'Electric, 60V 4Ah battery', GETDATE(), null, 32.4, 1,
	...
	('Grass Guzzler 9000', 1999.99, 8, null, 'Petrol, 10 litre tank', GETDATE(), null, 165.5, 2,
	...
	('Xtreme', 3999.99, 7, null, 'Petrol, 20 litre tank', GETDATE(), 10, null, 2,
...
VALUES (3, 1, GETDATE(), 5999.99, 'John Doe', 'john.doe@email.com', '1234567890'),
	(1, 2, GETDATE(), 449.99, 'John Smith', 'john.smith@email.com', '1234567890'),
	(1, 4, GETDATE(), 3999.99, 'Jane Doe', 'jane.doe@email.com', '1234567890'),
	(5, 2, GETDATE(), 499.99, 'John Doe', 'jane.doe@email.com', '1234567890');